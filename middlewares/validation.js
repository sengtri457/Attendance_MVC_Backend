...
const teacherValidation = {
    create: [
        body("teacher_name_kh").notEmpty().withMessage("Teacher name in Khmer is required").isLength(
            {max: 100}
        ).withMessage("Teacher name in Khmer must be less than 100 characters"),
        body("teacher_name_eng").notEmpty().withMessage("Teacher name in English is required").isLength(
            {max: 100}
        ).withMessage("Teacher name in English must be less than 100 characters"),
        body("email").optional().isEmail().withMessage("Invalid email format"),
        body("phone").optional().isLength(
            {max: 20}
        ).withMessage("Phone number must be less than 20 characters"),
    ],
    update: [
        body("teacher_name_kh").optional().isLength(
            {max: 100}
        ).withMessage("Teacher name in Khmer must be less than 100 characters"),
        body("teacher_name_eng").optional().isLength(
            {max: 100}
        ).withMessage("Teacher name in English must be less than 100 characters"),
        body("email").optional().isEmail().withMessage("Invalid email format"),
        body("phone").optional().isLength(
...
const subjectValidation = {
    create: [
        body("subject_name").notEmpty().withMessage("Subject name is required").isLength(
            {max: 100}
        ).withMessage("Subject name must be less than 100 characters"),
        body("subject_code").notEmpty().withMessage("Subject code is required").isLength(
            {max: 20}
        ).withMessage("Subject code must be less than 20 characters"),
        body("description").optional(),
    ],
    update: [
        body("subject_name").optional().isLength(
            {max: 100}
        ).withMessage("Subject name must be less than 100 characters"),
        body("subject_code").optional().isLength(
            {max: 20}
        ).withMessage("Subject code must be less than 20 characters"),
        body("description").optional(),
    ]
...
const classValidation = {
    create: [
        body("class_code").notEmpty().withMessage("Class code is required").isLength(
            {max: 20}
        ).withMessage("Class code must be less than 20 characters"),
        body("class_year").optional().isLength(
            {max: 50}
...
const studentValidation = {
    create: [
        ...
        body("student_name_kh").notEmpty().withMessage("Student name in Khmer is required").isLength(
            {max: 100}
        ).withMessage("Student name in Khmer must be less than 100 characters"),
        body("student_name_eng").notEmpty().withMessage("Student name in English is required").isLength(
            {max: 100}
        ).withMessage("Student name in English must be less than 100 characters"),
        body("gender").optional().isIn(
            ["M", "F", "O"]
    ...
    update: [
        ...
        body("student_name_kh").optional().isLength(
            {max: 100}
        ).withMessage("Student name in Khmer must be less than 100 characters"),
        body("student_name_eng").optional().isLength(
            {max: 100}
        ).withMessage("Student name in English must be less than 100 characters"),
        body("gender").optional().isIn(
            ["M", "F", "O"]
...
const validateAttendance = [
    ...
    body("attendance_date").isDate().withMessage("Valid attendance_date (YYYY-MM-DD) is required"),
    body("status").isIn(
        ["P", "A", "L", "E"]
...
const validateBulkAttendance = [
    ...
    body("records.*.status").optional().isIn(
        ["P", "A", "L", "E"]
    ).withMessage("Status must be P, A, L, or E"),
];
